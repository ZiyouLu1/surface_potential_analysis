...
def plot_wavepacket() -> None:
    ...
    normalized = normalize_wavepacket(wavepacket, idx=(2,))
    ...
    normalized = normalize_wavepacket(wavepacket, idx=(200,))
    plot_wavepacket_1d_x(normalized, ax=ax)
...
def test_wavepacket_normalization() -> None:
    ...
    _, _, ln_3 = plot_wavepacket_1d_x(normalized, measure="angle", ax=ax2)
    ln_0.set_label("0")
    ln_1.set_color(ln_0.get_color())
    ln_1.set_linestyle("--")
    ln_2.set_color(ln_0.get_color())
    ln_2.set_linestyle("--")
    ln_3.set_color(ln_0.get_color())
    ln_3.set_linestyle("--")
