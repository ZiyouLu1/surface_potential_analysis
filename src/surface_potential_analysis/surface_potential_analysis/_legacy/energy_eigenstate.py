...
class EnergyEigenstatesLegacy(TypedDict):
...
def save_energy_eigenstates(data: EnergyEigenstatesLegacy, path: Path) -> None:
...
def load_energy_eigenstates(path: Path) -> EnergyEigenstatesLegacy:
...
def get_eigenstate_list(eigenstates: EnergyEigenstatesLegacy) -> list[Eigenstate]:
    return [
        {
...
def get_bloch_phases(
    data: EnergyEigenstatesLegacy, origin_point: tuple[float, float, float]
):
...
def normalize_eigenstate_phase(
    data: EnergyEigenstatesLegacy, origin_point: tuple[float, float, float] = (0, 0, 0)
...
def filter_eigenstates_band(
    eigenstates: EnergyEigenstatesLegacy, n: int = 0
) -> EnergyEigenstatesLegacy:
...
def filter_eigenstates_n_point(eigenstates: EnergyEigenstatesLegacy, n: int):
