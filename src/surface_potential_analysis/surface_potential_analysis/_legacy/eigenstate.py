...
class EigenstateConfig(SurfaceConfig):
    ...
    """Resolution in x0,x1,x2 to produce the eigenstates in"""
    sho_omega: float
...
class EigenstateBasis:
    eigenstates_x0: NDArray | None
    """List of Eigenstates we are using in the x0 direction"""
    eigenstates_x1: NDArray | None
    """List of Eigenstates we are using in the x1 direction"""
    eigenstates_x2: NDArray | None
    """List of Eigenstates we are using in the x2 direction"""
