...
from nickel_111.s1_potential import get_interpolated_potential
...
def plot_brillouin_zone_points() -> None:
    ...
    fig, _, _ = plot_fundamental_x_in_plane_projected_2d(basis, 0, 2)
    fig.show()

    fig, ax, _ = plot_fundamental_k_in_plane_projected_2d(basis, 0, 2)
