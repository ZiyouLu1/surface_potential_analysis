...
class FigureBase(Artist):
    ...
    @overload
    def add_subplot(
        self, *args, projection: Literal["aitoff"], **kwargs
    ) -> AitoffAxes: ...
    @overload
    def add_subplot(
        self, *args, projection: Literal["hammer"], **kwargs
    ) -> HammerAxes: ...
    @overload
    def add_subplot(
        self, *args, projection: Literal["lambert"], **kwargs
    ) -> LambertAxes: ...
    @overload
    def add_subplot(
        self, *args, projection: Literal["mollweide"], **kwargs
    ) -> MollweideAxes: ...
    @overload
    def add_subplot(
        self, *args, projection: Literal["polar"], **kwargs
    ) -> PolarAxes: ...
    @overload
