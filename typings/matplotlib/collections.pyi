...
class Collection(Artist, ScalarMappable):
    ...
    def set_capstyle(
        self, cs: CapStyle | Literal["butt", "projecting", "round"]
    ) -> None: ...
...
class PathCollection(_CollectionWithSizes):
    def __init__(
        self, paths: Sequence[Path], sizes: ArrayLike = ..., **kwargs
    ) -> None: ...
...
class PolyCollection(_CollectionWithSizes):
    ...
    def set_verts_and_codes(
        self, verts: Sequence[ArrayLike], codes: ArrayLike
    ) -> None: ...

class BrokenBarHCollection(PolyCollection):
    def __init__(
        self, xranges: Sequence[Sequence[float]], yrange: Sequence[float], **kwargs
    ) -> None: ...
    @classmethod
...
class LineCollection(Collection):
    def __init__(
        self, segments: Sequence[ArrayLike], *, zorder: int = 2, **kwargs
    ) -> None: ...
...
class PatchCollection(Collection):
    def __init__(
        self, patches: Sequence[Patch], match_original: bool = ..., **kwargs
    ) -> None: ...
