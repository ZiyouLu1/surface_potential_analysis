...
class ortho_group_gen(multi_rv_generic):
    ...
    def rvs(self, dim, size=..., random_state=...): # -> NDArray[Unknown] | NDArray[floating[Any]]:
        """Draw random samples from O(N).
...
class ortho_group_frozen(multi_rv_frozen):
    ...
    def rvs(self, size=..., random_state=...): # -> NDArray[Unknown] | NDArray[floating[Any]]:
        ...
...
class vonmises_fisher_gen(multi_rv_generic):
    ...
    **Fitting the distribution parameters**
    ...
    def rvs(self, mu=..., kappa=..., size=..., random_state=...): # -> Any | NDArray[Any] | NDArray[Unknown] | NDArray[float64]:
        """Draw random samples from a von Mises-Fisher distribution.
...
class vonmises_fisher_frozen(multi_rv_frozen):
    ...
    def rvs(self, size=..., random_state=...): # -> Any | NDArray[Any] | NDArray[Unknown] | NDArray[float64]:
