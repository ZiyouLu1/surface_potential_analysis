...
class multivariate_normal_gen(multi_rv_generic):
    ...
    def __init__(self, seed=...) -> None: ...
    def __call__(
        self, mean=..., cov=..., allow_singular=..., seed=...
...
class dirichlet_gen(multi_rv_generic):
    ...
    def rvs(self, alpha, size=..., random_state=...):
        """
        Draw random samples from a Dirichlet distribution.
...
class wishart_gen(multi_rv_generic):
    ...
    def mean(
        self, df, scale
    ):  # -> ndarray[Any, dtype[signedinteger[Any]]] | Any | ndarray[Any, dtype[bool_]] | ndarray[Any, dtype[floating[Any]]] | ndarray[Any, dtype[complexfloating[Any, Any]]]:
...
class multinomial_gen(multi_rv_generic):
    ...
    def rvs(self, n, p, size=..., random_state=...):
        """Draw random samples from a Multinomial distribution.
...
class ortho_group_gen(multi_rv_generic):
    ...
    def rvs(
        self, dim, size=..., random_state=...
    ):  # -> NDArray[Unknown] | NDArray[floating[Any]]:
        """Draw random samples from O(N).
...
class multivariate_hypergeom_gen(multi_rv_generic):
    ...
    def logpmf(
        self, x, m, n
    ):  # -> float | ndarray[Any, dtype[Any]] | ndarray[Any, dtype[Unknown]]:
...
class vonmises_fisher_gen(multi_rv_generic):
    ...
    **Fitting the distribution parameters**
    ...
    ):  # -> Any | NDArray[Any] | NDArray[Unknown] | NDArray[float64]:
        """Draw random samples from a von Mises-Fisher distribution.
    ...
    def fit(self, x):  # -> tuple[Any, Unknown]:
