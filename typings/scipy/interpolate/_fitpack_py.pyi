...
def splev(
    x, tck, der=..., ext=...
):  # -> ndarray[Any, dtype[complex_ | float_]] | list[Unknown]:
    """
...
def splint(
    a, b, tck, full_output=...
):  # -> list[Unknown] | tuple[Unknown, ...] | Any | tuple[Unknown, Unknown]:
    """
...
def insert(
    x, tck, m=..., per=...
):  # -> BSpline | tuple[Unbound | Unknown, list[Unknown], Unbound | Unknown] | tuple[Unknown, Unknown, Unknown]:
    """
...
def splantider(
    tck, n=...
):  # -> BSpline | tuple[Unknown, Unknown | Any, Unknown] | tuple[Unknown | Any, Unknown | Any, Unknown]:
    """
