...
class RegularGridInterpolator:
    ...
    **Interpolate and extrapolate a 2D dataset**
    ...
    _ALL_METHODS = ...
    def __init__(
        self, points, values, method=..., bounds_error=..., fill_value=...
    ) -> None: ...
    def __call__(
        self, xi, method=...
    ):  # -> ndarray[Any, dtype[Any]] | ndarray[Any, dtype[bool_]] | ndarray[Any, dtype[Unknown]]:
        """
...
):  # -> ndarray[Any, dtype[Any]] | ndarray[Any, dtype[bool_]] | ndarray[Any, dtype[Unknown]] | None:
    """
