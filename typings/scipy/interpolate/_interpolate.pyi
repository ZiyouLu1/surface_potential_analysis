...
class interp1d(_Interpolator1D):
    ...
    @property
    def fill_value(self):  # -> tuple[Unknown, Unknown] | NDArray[Unknown]:
        """The fill value."""
        ...
...
class _PPolyBase:
    ...
    def __call__(
        self, x, nu=..., extrapolate=...
    ):  # -> ndarray[Any, dtype[complex_ | float_]]:
        """
...
class NdPPoly:
    ...
    ):  # -> NDArray[Unknown] | NDArray[complex_ | float_] | Any:
        """
        Compute a definite integral over a piecewise polynomial.
