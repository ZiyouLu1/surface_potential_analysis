...
def nonlin_solve(
    ...
    full_output=...,
    raise_exception=...,
):  # -> tuple[Any | ndarray[Any, dtype[Unknown]], dict[str, Unknown]] | Any | ndarray[Any, dtype[Unknown]]:
    """
...
def asjacobian(
    J,
):  # -> Jacobian | Jac | BroydenFirst | Anderson | DiagBroyden | LinearMixing | ExcitingMixing | KrylovJacobian:
    """
