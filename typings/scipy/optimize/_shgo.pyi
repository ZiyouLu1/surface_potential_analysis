...
class SHGO:
    ...
    def minimizers(self): # -> NDArray[Unknown]:
        """
    ...
    def sorted_samples(self): # -> tuple[NDArray[intp], ndarray[Any, dtype[Unknown]] | ndarray[Any, Unknown] | Unknown]:
