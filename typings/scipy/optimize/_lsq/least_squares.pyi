...
def call_minpack(
    fun, x0, jac, ftol, xtol, gtol, max_nfev, x_scale, diff_step
):  # -> OptimizeResult:
    ...
...
):  # -> tuple[Unknown | Literal[0], Unknown | Literal[0], Unknown | Literal[0]]:
    ...
...
def construct_loss_function(
    m, loss, f_scale
):  # -> ((f: Unknown, cost_only: bool = False) -> (Unknown | NDArray[float64])) | None:
    ...
def least_squares(
    fun,
    x0,
