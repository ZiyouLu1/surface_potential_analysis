...
class EnergyState:
    ...
    def update_best(
        self, e, x, context
    ):  # -> Literal['Callback function requested to stop early by retur…'] | None:
        ...
...
class StrategyChain:
    ...
    ):  # -> Literal['Maximum number of function call reached during ann…'] | None:
        ...
    def local_search(
        self,
    ):  # -> Literal['Maximum number of function call reached during loc…', 'Maximum number of function call reached during dua…'] | None:
        ...
...
class LocalSearchWrapper:
    ...
    def local_search(
        self, x, e
    ):  # -> tuple[Unknown, Unknown] | tuple[Unknown, NDArray[Unknown]]:
        ...
