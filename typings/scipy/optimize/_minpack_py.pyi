...
def fsolve(
    ...
    factor=...,
    diag=...,
):  # -> tuple[Unknown, dict[str, Unknown | None], Unknown, Unknown]:
    """
...
def curve_fit(
    f: Callable[..., Any],
    xdata: np.ndarray[Any, Any],
    ydata: np.ndarray[Any, Any],
    p0: np.ndarray[Any, Any] | list[Any] | tuple[Any, ...] = ...,
    sigma: None | np.ndarray[Any, Any] = ...,
    absolute_sigma: None = ...,
    check_finite: bool = ...,
    bounds: None | tuple[Any, ...] = ...,
