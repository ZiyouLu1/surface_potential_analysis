...
):  # -> tuple[Literal[0], Literal[0], Literal[False]] | tuple[float | Literal[0], float | Literal[1], Literal[True]] | tuple[Any | Unknown | int, Any | Unknown | int, bool]:
...
):  # -> tuple[Any, Any, bool, dict[str, Unknown], dict[str, Unknown]] | tuple[Any, Any, bool]:
...
def projected_cg(
    ...
    max_infeasible_iter=...,
    return_all=...,
):  # -> tuple[Unknown, dict[str, Unknown]] | tuple[Unknown | Any, dict[str, Unknown]]:
