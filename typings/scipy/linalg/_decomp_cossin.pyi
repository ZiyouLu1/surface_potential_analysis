...
__all__ = ['cossin']
def cossin(X, p=..., q=..., separate=..., swap_sign=..., compute_u=..., compute_vh=...): # -> tuple[tuple[Unknown, Unknown], Unknown, tuple[Unknown, Unknown]] | tuple[Unknown, NDArray[float64], Unknown]:
    """
