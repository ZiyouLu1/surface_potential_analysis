...
lapack_cast_dict = ...
def solve(a, b, lower=..., overwrite_a=..., overwrite_b=..., check_finite=..., assume_a=..., transposed=...): # -> NDArray[Unknown]:
    """
...
def solve_banded(l_and_u, ab, b, overwrite_ab=..., overwrite_b=..., check_finite=...):
    """
...
def solve_toeplitz(c_or_cr, b, check_finite=...): # -> ndarray[Any, dtype[Unknown]]:
...
def det(a, overwrite_a=..., check_finite=...): # -> float64 | NDArray[float64] | NDArray[Any] | complex128:
    """
...
def matrix_balance(A, permute=..., scale=..., separate=..., overwrite_a=...): # -> tuple[Unknown, tuple[NDArray[Any], Unknown]] | tuple[Unknown, ndarray[Any, dtype[Any]]]:
    """
