...
):  # -> NDArray[complex128 | floating[_64Bit]] | ndarray[Any, _dtype] | NDArray[complex128]:
...
):  # -> float64 | NDArray[float64] | NDArray[Any] | complex128:
    """
...
def pinv(
    a, atol=..., rtol=..., return_rank=..., check_finite=..., cond=..., rcond=...
...
):  # -> tuple[Unknown, tuple[NDArray[Any], Unknown]] | tuple[Unknown, ndarray[Any, dtype[Any]]]:
    """
