...
def lu(a, permute_l=..., overwrite_a=..., check_finite=..., p_indices=...): # -> tuple[NDArray[Any], NDArray[Any]] | tuple[NDArray[int32] | NDArray[Any], NDArray[Any], NDArray[Any]] | tuple[NDArray[Any] | NDArray[Unknown], NDArray[Any] | NDArray[Unknown]] | tuple[NDArray[Any] | NDArray[Unknown], NDArray[Any] | NDArray[Unknown], NDArray[Any] | NDArray[Unknown]] | tuple[NDArray[Any] | NDArray[int32], NDArray[Any] | NDArray[Unknown], NDArray[Any] | NDArray[Unknown]]:
    """
