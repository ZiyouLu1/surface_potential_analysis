...
def kelvin_zeros(
    nt,
):  # -> tuple[Unknown, Unknown, Unknown, Unknown, Unknown, Unknown, Unknown, Unknown]:
...
def comb(
    N, k, exact=..., repetition=..., legacy=...
):  # -> ndarray[Unknown, Unknown] | float64 | Any:
...
def factorial(
    n, exact=...
):  # -> float | int | Any | NDArray[Unknown] | NDArray[float64] | NDArray[Any]:
    """
...
def factorial2(
    n, exact=...
):  # -> float | Any | NDArray[Unknown] | NDArray[float64] | NDArray[Any] | Literal[0, 1]:
    """Double factorial.
...
def factorialk(
    n, k, exact=...
):  # -> float | NDArray[Unknown] | NDArray[float64] | NDArray[Any] | Literal[0, 1]:
