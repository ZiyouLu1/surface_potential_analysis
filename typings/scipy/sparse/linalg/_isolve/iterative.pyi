...
def set_docstring(
    header, Ainfo, footer=..., atol_default=...
):  # -> (fn: Unknown) -> Unknown:
    ...
@set_docstring(
...
):  # -> tuple[NDArray[Any] | ndarray[Any, dtype[Unknown]] | ndarray[Any, Unknown], Literal[0]] | tuple[Any, Any]:
    ...
@set_docstring(
...
def cgs(
    A, b, x0=..., tol=..., maxiter=..., M=..., callback=..., atol=...
):  # -> tuple[NDArray[Any] | ndarray[Any, dtype[Unknown]] | ndarray[Any, Unknown], Literal[0]] | tuple[Any, Any | Literal[0]]:
    ...
@non_reentrant()
def gmres(
    A,
