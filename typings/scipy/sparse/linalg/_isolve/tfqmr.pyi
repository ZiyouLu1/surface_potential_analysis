...
def tfqmr(
    A, b, x0=..., tol=..., maxiter=..., M=..., callback=..., atol=..., show=...
):  # -> tuple[ndarray[Any, dtype[Any]], Literal[0]] | tuple[NDArray[Any] | ndarray[Any, dtype[Unknown]] | ndarray[Any, Unknown], Literal[0]] | tuple[NDArray[Any] | ndarray[Any, dtype[Unknown]] | ndarray[Any, Unknown] | Any, Literal[-1]] | tuple[Any, Literal[0]] | tuple[NDArray[Any] | ndarray[Any, dtype[Unknown]] | ndarray[Any, Unknown] | Any, int | Unknown]:
    """
