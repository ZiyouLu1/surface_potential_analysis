...
class _spbase:
    ...
    def reshape(self, *args, **kwargs):  # -> _spbase | Self@_spbase:
    ...
    def astype(self, dtype, casting=..., copy=...):  # -> _spbase | Self@_spbase:
    ...
    __nonzero__ = ...
    def __len__(self): ...
    def asformat(self, format, copy=...):  # -> _spbase | Self@_spbase | Any:
    ...
    def __add__(self, other):  # -> _spbase | _NotImplementedType:
        ...
    def __radd__(self, other):  # -> _spbase | _NotImplementedType:
        ...
    def __sub__(self, other):  # -> _spbase | NDArray[Any] | _NotImplementedType:
        ...
    ...
    def __matmul__(
        self, other
    ):  # -> _NotImplementedType | ndarray[Any, dtype[Unknown]] | ndarray[Any, Unknown] | matrix[Unknown, Unknown]:
        ...
    ...
    def conjugate(self, copy=...):  # -> _spbase | Self@_spbase:
    ...
    def conj(self, copy=...):  # -> _spbase | Self@_spbase:
        ...
    ...
    def todense(
        self, order=..., out=...
    ):  # -> NDArray[Unknown] | matrix[Unknown, Unknown]:
        """
    ...
    shape = ...
    def asfptype(self):  # -> Self@_spbase | _spbase:
