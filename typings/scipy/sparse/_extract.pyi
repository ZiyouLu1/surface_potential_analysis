...
def find(A): # -> tuple[ndarray[Any, dtype[int32 | int64]] | Unknown, ndarray[Any, dtype[int32 | int64]] | Unknown, ndarray[Any, dtype[Unknown]] | ndarray[Any, Unknown] | Unknown | ndarray[Any, dtype[float64]] | ndarray[Any, dtype[Any]]]:
...
def tril(A, k=..., format=...): # -> _spbase | coo_matrix | Any:
...
def triu(A, k=..., format=...): # -> _spbase | coo_matrix | Any:
