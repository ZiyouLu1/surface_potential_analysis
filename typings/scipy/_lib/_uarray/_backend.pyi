...
def pickle_function(
    func,
):  # -> tuple[(mod_name: Unknown, qname: Unknown, self_: Unknown) -> (MethodType | ModuleType | Any), tuple[Any | None, Any | None, Any | None]]:
    ...
...
def create_multimethod(
    *args, **kwargs
):  # -> (a: Unknown) -> _Wrapped[..., Tuple[Dispatchable, ...], ..., Unknown]:
    """
...
def generate_multimethod(
    ...
    domain: str,
    default: typing.Optional[typing.Callable] = ...,
):  # -> _Wrapped[..., Tuple[Dispatchable, ...], ..., Unknown]:
    """
    Generates a multimethod.
...
def get_defaults(
    f,
):  # -> tuple[dict[Unknown, Unknown], tuple[Unknown, ...], set[Unknown]]:
    ...
...
def all_of_type(
    arg_type,
):  # -> (func: Unknown) -> _Wrapped[..., Unknown, (*args: Unknown, **kwargs: Unknown), tuple[Dispatchable, ...]]:
    """
...
def wrap_single_convertor(
    convert_single,
):  # -> _Wrapped[..., Unknown, (dispatchables: Unknown, coerce: Unknown), _NotImplementedType | list[Unknown]]:
    """
...
def wrap_single_convertor_instance(
    convert_single,
):  # -> _Wrapped[..., Unknown, (self: Unknown, dispatchables: Unknown, coerce: Unknown), _NotImplementedType | list[Unknown]]:
    """
    Wraps a ``__ua_convert__`` defined for a single element to all elements.
    If any of them return ``NotImplemented``, the operation is assumed to be
    undefined.
