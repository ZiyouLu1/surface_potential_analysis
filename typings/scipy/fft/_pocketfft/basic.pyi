...
def fft2(x, s=..., axes=..., norm=..., overwrite_x=..., workers=..., *, plan=...):
    """
    2-D discrete Fourier transform.
    """
    ...

def ifft2(x, s=..., axes=..., norm=..., overwrite_x=..., workers=..., *, plan=...):
    """
    2-D discrete inverse Fourier transform of real or complex sequence.
    """
    ...

def rfft2(x, s=..., axes=..., norm=..., overwrite_x=..., workers=..., *, plan=...):
    """
    2-D discrete Fourier transform of a real sequence
    """
    ...

def irfft2(x, s=..., axes=..., norm=..., overwrite_x=..., workers=..., *, plan=...):
    """
